...
public class GetChapterHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    
    private static final Logger logger = LoggingHelper.getLogger(GetChapterHandler.class);

    private final ChapterService chapterService;

    public GetChapterHandler() {
        this.chapterService = new ChapterServiceImpl();
    }

    public GetChapterHandler(ChapterService chapterService) {
