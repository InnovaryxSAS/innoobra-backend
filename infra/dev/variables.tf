...
variable "lambdas" {
  ...
  default = {
    ...
    create_company = {
      ...
      jar_path  = "lambdas/company/company-1.0-SNAPSHOT.jar"
    ...
    jar_path  = "lambdas/project/project-1.0-SNAPSHOT.jar"
    ...
    create_role = {
      ...
      jar_path  = "lambdas/role/role-1.0-SNAPSHOT.jar"
      route_key = "POST /role"
    },
    get_role = {
    ...
    create_chapter = {
      ...
      jar_path  = "lambdas/chapter/chapter-1.0-SNAPSHOT.jar"
    ...
    create_activity = {
      ...
      jar_path  = "lambdas/activity/activity-1.0-SNAPSHOT.jar"
    ...
    create_attribute = {
      ...
      jar_path  = "lambdas/attribute/attribute-1.0-SNAPSHOT.jar"
    ...
    create_apudetail = {
      ...
      jar_path  = "lambdas/apudetail/apudetail-1.0-SNAPSHOT.jar"
